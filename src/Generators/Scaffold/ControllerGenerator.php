...
class ControllerGenerator extends BaseGenerator
{
    ...
    public function generate()
    {
        if ($this->commandData->getAddOn('datatables')) {
            $templateData = get_template('scaffold.controller.datatable_controller', 'ghost-generator');

            $this->generateDataTable();
        } else {
            $templateData = get_template('scaffold.controller.controller', 'ghost-generator');
    ...
    {
        $templateData = get_template('scaffold.datatable', 'ghost-generator');
